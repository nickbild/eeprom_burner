...
//
// Set FFFC-FFFD to 32752 (little endian):
// 111111111111100 -> 11110000
// 111111111111101 -> 01111111
//
...
void loop(){
  ...
  if (doWrite == 1) {
    // 111111111111100 -> 11110000
    write(HIGH, HIGH, LOW, LOW, 1,1,1,1,0,0,0,0);
    // 111111111111101 -> 01111111
    write(HIGH, HIGH, LOW, HIGH, 0,1,1,1,1,1,1,1);
    // 111111111110000 -> 11101010
